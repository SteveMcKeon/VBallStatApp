  ...
  return (
    ...
    <div className="h-px bg-gray-300 mx-2 mb-2" />      
      ...
      {isPopupOpen && (
        <div
          ref={popupRef}
          className="absolute bottom-[60px] left-[10px] right-[10px] bg-white border border-gray-300 rounded-[12px] shadow-lg z-50"
        >
        <div className="p-4 flex items-center space-x-3">
          <svg viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6 text-gray-500">
